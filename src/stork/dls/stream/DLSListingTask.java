...
public class DLSListingTask {
	...
	public final String fethchingPath;
    ...
    private FuseClient proxyclient = null;
    
    public FuseClient getClient(){
        return proxyclient;
    }
    
    public void bindClient(FuseClient proxyclient){
        this.proxyclient = proxyclient;
    }
    public DLSListingTask(final String host, final String path){
    	TTL = 3;
    	serverName = host;
    	fethchingPath = path;
        cachekey = host+"@"+path;
	...
	public void setCachekey(String path) {
		this.cachekey = this.serverName+"@"+path;
	}
}
